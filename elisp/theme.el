;;; Low-contrast White-on-Transparent by Rob Kelly.
;;; Based on White-on-Grey by S.Pokrovsky.
...
(custom-theme-set-faces
    ...
    '(default ((t (:background "unspecified-bg" :foreground "White"))))
